...
//                [self addSubview:separator];
        ...
        cancel.frame = CGRectMake(0, y, _screenRect.size.width, 44);
        [cancel setTitle:NSLocalizedString(@"Cancel", @"cancel button name") forState:UIControlStateNormal];
        [cancel setTitleColor:[UIColor colorWithRed:107.0/255.0 green:154.0/255.0 blue:225.0/255.0 alpha:1] forState:UIControlStateNormal];
        cancel.titleLabel.font = [UIFont systemFontOfSize:20];
        cancel.backgroundColor = [UIColor colorWithRed:243.0/255.0 green:243.0/255.0 blue:243.0/255.0 alpha:1];
