...
class ShopOrderPayViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,popPayDelegate {
    ...
    func creatCustomNavigationBar() {
        ...
        backBtn.addTarget(self, action: #selector(ShopOrderPayViewController.backClicked), forControlEvents: UIControlEvents.TouchUpInside)
        backBtn.opaque = true
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            checkBtn.addTarget(self, action: #selector(ShopOrderPayViewController.checkBtnPressed(_:)), forControlEvents: .TouchUpInside)
