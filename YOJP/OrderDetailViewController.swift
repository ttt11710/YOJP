...
//    }
    ...
    func creatCustomNavigationBar() {
        ...
        backBtn.addTarget(self, action: #selector(OrderDetailViewController.backClicked), forControlEvents: UIControlEvents.TouchUpInside)
        backBtn.opaque = true
    ...
    func creatScrollView() {
        ...
        let tap : UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(OrderDetailViewController.showSucceedView))
