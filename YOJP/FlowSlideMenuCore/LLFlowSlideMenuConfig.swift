...
public struct FlowSlideMenuOptions {
    ...
    public static var animationDuration: CGFloat = 0.0
...
public struct FlowCurveOptions {
    public static var bgColor : UIColor = UIColor(white: 0.0, alpha: 0.6)
    ...
    public static var animation_damping:CGFloat = 15
