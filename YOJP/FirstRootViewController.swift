...
/**  导航栏的高度  */
var navBarH:CGFloat = 64
/**  title 放大比例  */
var maxTitleScale:CGFloat = 1.1

class FirstRootViewController: UIViewController, UIScrollViewDelegate {
    ...
    func addChildViewController(){
        ...
        let vc3 = DiscountViewController()
        vc3.title = "打折券"
