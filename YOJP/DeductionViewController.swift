...
class DeductionViewController: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                ...
                imageView.image = UIImage(named: "现金券banner")
            ...
            cell.imageView1.image = UIImage(named: "现金券图片设计")
            cell.imageView2.image = UIImage(named: "现金券图片设计")
            cell.label1.text = "只需50元，就可以体验200元的消费，还等什么呢"
            cell.label2.text = "只需50元，就可以体验200元的消费，还等什么呢"
