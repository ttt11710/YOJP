...
static CGFloat const kJPSThumbnailAnnotationViewVerticalMyOffset    = 30.0f;
...
- (void)setupTitleLabel {
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-32.0f, 4.0f, 168.0f, 20.0f)];
...
- (void)setupSubtitleLabel {
    _subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-32.0f, 28.0f, 168.0f, 60.0f)];
...
- (void)expand {
    ...
    self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, self.frame.size.width+kJPSThumbnailAnnotationViewExpandOffset, self.frame.size.height+kJPSThumbnailAnnotationViewVerticalMyOffset);
    self.centerOffset = CGPointMake(kJPSThumbnailAnnotationViewExpandOffset/2.0f, -kJPSThumbnailAnnotationViewVerticalOffset-kJPSThumbnailAnnotationViewVerticalMyOffset/2.0f);
...
- (void)shrink {
    ...
    self.frame = CGRectMake(self.frame.origin.x,
                            ...
                            self.frame.size.height-kJPSThumbnailAnnotationViewVerticalMyOffset);
...
- (void)animateBubbleWithDirection:(JPSThumbnailAnnotationViewAnimationDirection)animationDirection {
    ...
    [UIView animateWithDuration:kJPSThumbnailAnnotationViewAnimationDuration animations:^{
        ...
        CGFloat yOffset = (growing ? -1 : 1) * kJPSThumbnailAnnotationViewVerticalMyOffset/2.0f;
        self.imageView.frame = CGRectOffset(self.imageView.frame, xOffset, yOffset);
    } completion:^(BOOL finished) {
    ...
    CGRect largeRect = CGRectInset(self.bounds, -kJPSThumbnailAnnotationViewExpandOffset/2.0f, -kJPSThumbnailAnnotationViewVerticalMyOffset/2.0f);
...
- (void)didTapDisclosureButton {
    if (self.disclosureBlock) self.disclosureBlock(self.tag);
}
